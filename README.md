...
- [Numbers](https://github.com/pragalakis/100-python-projects#numbers)
- [Classic Algorithms](https://github.com/pragalakis/100-python-projects#classic-algorithms)
- [Graph](https://github.com/pragalakis/100-python-projects#graph)
- [Data Structures](https://github.com/pragalakis/100-python-projects#data-structures)
- [Text](https://github.com/pragalakis/100-python-projects#text)
- [Networking](https://github.com/pragalakis/100-python-projects#networking)
- [Classes](https://github.com/pragalakis/100-python-projects#classes)
- [Threading](https://github.com/pragalakis/100-python-projects#threading)
- [Web](https://github.com/pragalakis/100-python-projects#web)
- [Files](https://github.com/pragalakis/100-python-projects#files)
- [Databases](https://github.com/pragalakis/100-python-projects#databases)
- [Graphics and Multimedia](https://github.com/pragalakis/100-python-projects#graphics-and-multimedia)
- [Security](https://github.com/pragalakis/100-python-projects#security)
...
**Web Browser** – Create a small web browser that allows you to navigate the web. *For simplicity don’t worry about executing Javascript or other client side code.*
...
**Tumblr Image Scraper** - Scrape and save all the images from a given tubmlr blog page.
